# ====================================================================================
# Setup Project
PROJECT_NAME := provider-fitscloudnative
...
IMAGES = provider-fitscloudnative
...
XPKGS = provider-fitscloudnative
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-fitscloudnative: do.build.images
...
# This target prepares repo for your provider by replacing all "fitscloudnative"
